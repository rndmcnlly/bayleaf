 ...
 *   GET /docs/SKILL.md               — Agent skill file (authenticated or campus)
...
docsRoutes.get('/SKILL.md', async (c) => {
  ...
  if (!user) {
    return c.text('Authentication required. Use Authorization: Bearer sk-bayleaf-..., or access from the campus network.', 401);
  }
...
//
// SKILL.md and GWS endpoints require a session cookie, Bearer
// sk-bayleaf-* token, or campus network access (Campus Pass).
