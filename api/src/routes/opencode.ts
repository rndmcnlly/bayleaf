...
opencodeRoutes.get('/SKILL.md', async (c) => {
  ...
  const lines = [
    '---',
    'name: bayleaf-api',
    'description: Set up BayLeaf API (api.bayleaf.dev) as an OpenCode provider for free LLM access at UC Santa Cruz.',
    '---',
    '',
    ...
    '- Visit <https://api.bayleaf.dev/> and sign in to provision your personal API key.',
    ...
    '',
    fence,
    'GET https://api.bayleaf.dev/recommended-model',
    fence,
    '',
